...
const dictionaries = {
  en: {
    ...
    'pricing.f1': '1 user',
    'pricing.f2': 'Unlimited event types',
    'pricing.f3': 'Google Calendar sync',
    'pricing.f4': 'Email notifications',
    'pricing.f5': 'PayPal payments',
    'pricing.t1': 'Everything in Free',
    'pricing.t2': 'Team scheduling',
    'pricing.t3': 'Remove branding',
    'pricing.t4': 'Custom domain',
    'pricing.t5': 'Priority support',
    ...
    'cal.title': 'Calendar Integrations',
    'cal.googleDesc': 'Block busy times and add bookings to your Google Calendar',
    'cal.connect': 'Connect',
  ...
  ko: {
    ...
    'pricing.f1': '1인 사용',
    'pricing.f2': '이벤트 종류 무제한',
    'pricing.f3': '구글 캘린더 연동',
    'pricing.f4': '이메일 알림',
    'pricing.f5': 'PayPal 결제',
    'pricing.t1': 'Free 전부 포함',
    'pricing.t2': '팀 스케줄링',
    'pricing.t3': '브랜딩 제거',
    'pricing.t4': '커스텀 도메인',
    'pricing.t5': '우선 지원',
    ...
    'cal.title': '캘린더 연동',
    'cal.googleDesc': '바쁜 시간 차단 + 예약을 구글 캘린더에 자동 등록',
    'cal.connect': '연결하기',
    'cal.disconnect': '연결 해제',
    'cal.connected': '구글 캘린더 연결됐어요!',
